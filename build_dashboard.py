...
<div class="controls">
  <div class="ctrl-group"><label>Period Filter (Stack KPIs)</label>
    <select id="periodSelect"><option value="0">YTD (P1-P8)</option>
    <option value="8">P8</option><option value="7">P7</option><option value="6">P6</option><option value="5">P5</option><option value="4">P4</option>
...
<div class="main">
  ...
  <p class="note">YTD P1-P8: 2024 / 2025 / 2026 comparable periods only</p>
...
const FY26_PERIODS = [1,2,3,4,5,6,7,8];
